        ...
        <Card style={{ padding: 20, borderRadius: 18, boxShadow: '0 14px 36px rgba(15, 23, 42, 0.08)', background: 'linear-gradient(135deg, rgba(14, 124, 134, 0.06), rgba(108, 63, 197, 0.04))' }}>
          ...
          {(showRegistrationQr || showKycQr) ? (
            <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap', marginTop: 20 }}>
              {showRegistrationQr ? (
                <div style={{ padding: 14, borderRadius: 14, background: 'rgba(255, 255, 255, 0.92)', border: '1px solid rgba(15, 23, 42, 0.08)', textAlign: 'center', minWidth: 140, boxShadow: '0 8px 20px rgba(15, 23, 42, 0.06)' }}>
